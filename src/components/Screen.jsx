        ...
        >
            ...
            >
                <Link href="https://t.me/v_3_t_o">
                    <Button
                        className="bg-gold hover:shadow-[#8c6032] px-9 py-3 rounded text-white font-bold text-3xl shadow-lg hover:shadow-xl active:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 active:translate-y-0"
                    >
                        Accept
                    </Button>
                </Link>
