...
const AboutMe = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row bg-[#202124] p-8 h-screen justify-center align-middle gap-20 overflow-hidden" id="about_me">
            <motion.img
                src={ myPhoto }
                alt="My photo"
                className="object-cover min-w-[310px] max-h-[310px] rounded-full self-center m-0 p-0"
            ...
            <div className="flex flex-col justify-center text-white">
                ...
                >
                    Viktor Gavryliuk, (c)АСУ, може 2 курс буду.
                </motion.h2>
                <motion.p
